...
| [Phone app feature record](../app/README.md) | What `code/app` actually implements, why adapting to users is a profile+primitives runtime (not a Flutter screen per person), and the Expo port map |
