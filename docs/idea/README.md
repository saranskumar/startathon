...
| [24 — Meeting Notes: Onboarding Entry & Accessibility](24-meeting-notes-onboarding-entry-and-accessibility.md) | Voice-memo transcript ([GH #1](https://github.com/saranskumar/startathon/issues/1)) raising the calibration-entry bootstrapping problem, high contrast, screen-reader support, recorded onboarding audio, and progressive input levels — researched in [tech/research/11](../tech/research/11-accessible-entry-onboarding-and-contrast.md) |
| [25 — Meeting Notes: Caregiver Training Mode](25-meeting-notes-caregiver-training-mode.md) | Voice-memo transcript ([GH #2](https://github.com/saranskumar/startathon/issues/2)) proposing a caregiver-guided pre-calibration training mode — researched in [tech/research/12](../tech/research/12-caregiver-guided-training-mode.md) as the established "physical prompting" OT/ABA technique |
| [26 — Meeting Notes: Voice Vocabulary Calibration](26-meeting-notes-voice-vocabulary-calibration.md) | Voice-memo transcript ([GH #3](https://github.com/saranskumar/startathon/issues/3)) proposing sentence-based voice calibration that builds a per-word personal vocabulary, used to dynamically label task options — researched in [tech/research/13](../tech/research/13-sentence-based-voice-vocabulary-calibration.md) |
| [27 — Meeting Notes: Visual Field Loss](27-meeting-notes-visual-field-loss.md) | Voice-memo transcript ([GH #4](https://github.com/saranskumar/startathon/issues/4)) raising tunnel vision and central/peripheral-only vision as a new, under-built axis — researched in [tech/research/14](../tech/research/14-visual-field-loss-tunnel-and-peripheral-vision.md) |
| [UI/UX phone flow](../desgin/ui-ux-phone-flow.md) | Wireframe-style inventory of every phone screen, essential vs supporting UI, and the locked calibration → preview → task → confirm flow |
| [28 — Scope Lock: No AI At All](28-meeting-notes-scope-lock-no-ai.md) | Team decision: zero AI/LLM anywhere (goes beyond the earlier "narrow AI" framing), mock UI as the primary demo with the real Google Form as a judge-requested secondary demo, open-source/no-revenue positioning reaffirmed — see [tech/research/15](../tech/research/15-google-nai-comparison.md) for the resulting comparison against Google's NAI |
| [Phone app feature record](../app/README.md) | What `code/app` actually implements, why adapting to users is a profile+primitives runtime (not a Flutter screen per person), the Expo port map, and [04 — clarity / field / playground plan](../app/04-clarity-playground-and-field.md) |
| [29 — Phone ↔ Desktop Integration](29-phone-desktop-integration.md) | Fills in the "phone↔agent transport" gap tech/README.md flagged as unstarted: landmark-based region highlighting (top bar / side panel / main content), a WebSocket transport (`code/desktop/src/phoneTransport.js`), the input-method handshake, and a generalized N-ary scan/voice-grid tree (`scanTree.js`) for switch-scanning and grid-based voice selection |
| [30 — Meeting Notes: Onboarding & Calibration Walkthrough](30-meeting-notes-onboarding-calibration-walkthrough.md) | Live usability walkthrough of `code/app`'s onboarding/calibration flow, organized into 13 issues cross-checked against actual code (file/line refs) and against the locked [UI/UX phone flow](../desgin/ui-ux-phone-flow.md) spec — flags 4 direct conflicts between the feedback and the locked spec that need a decision, not yet implemented |
